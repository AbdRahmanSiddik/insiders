        ...
        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
          <div class="course__item-2 transition-3 white-bg mb-30 fix">
            <div class="course__thumb-2 w-img fix">
              <a href="/galeri/{{ $item->token_galeri }}/detail">
            ...
            <div class="course__content-2">
              <div class="course__top-2 d-flex align-items-center justify-content-between">
                <div class="course__tag-2">
                  <a href="/ukm/{{ $item->id_ukm }}/all">{{ $item->nama_ukm }}</a>
                </div>
              ...
              <h3 class="course__title-2">
                <a href="/galeri/{{ $item->token_galeri }}/detail">{{ $item->nama_galeri }}</a>
              </h3>
                          ...
                          <span>
                            <svg width="10" height="12" viewBox="0 0 10 12" fill="none"
                              ...
                              <path
                                ...
                                stroke="#5F6160" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                              <path d="M9 11.0001C9 9.22632 7.20722 7.79175 5 7.79175C2.79278 7.79175 1 9.22632 1 11.0001"
                                stroke="#5F6160" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                          </span>
                        </div>
                          ...
                          <span>
                            <svg width="14" height="12" viewBox="0 0 14 12" fill="none"
                              ...
                              <path
                                ...
                                stroke="#5F6160" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" />
                              <path
