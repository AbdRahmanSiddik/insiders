...
@section('content')
      ...
      <div class="swiper-wrapper">
        <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
          <div class="slider__bg slider__overlay include-bg"
            data-background="{{ asset('eduker') }}/assets/img/slider/slider-1.jpg"></div>
          <div class="container">
            <div class="row">
              <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10 col-sm-10">
                <div class="slider__content p-relative z-index-1">
                  <span data-animation="fadeInUp" data-delay=".3s">INSIDER UNIBA MADURA</span>
                  <h2 class="slider__title" data-animation="fadeInUp" data-delay=".6s">Sistem Informasi UKM UNIBA
                    Terpercaya
                  </h2>
                  <p data-animation="fadeInUp" data-delay=".9s">Kesempatan tidak datang dua kali, kesempatan datang kepada
                    orang yang tidak pernah berhenti mencoba. <small>#Dzawin</small></p>
                  <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                    <a href="/ukm/all" class="tp-btn">Lihat UKM</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="slider__item swiper-slide p-relative slider__height d-flex align-items-center z-index-1">
          <div class="slider__bg slider__overlay include-bg"
            data-background="{{ asset('eduker') }}/assets/img/slider/slider-2.jpg"></div>
          <div class="container">
            <div class="row">
              <div class="col-xxl-7 col-xl-8 col-lg-8 col-md-10 col-sm-10">
                <div class="slider__content p-relative z-index-1">
                  <span data-animation="fadeInUp" data-delay=".3s">INSIDER UNIBA MADURA</span>
                  <h2 class="slider__title" data-animation="fadeInUp" data-delay=".6s">Berita UKM UNIBA Terupdate
                  </h2>
                  <p data-animation="fadeInUp" data-delay=".9s">Kemarin adalah sejarah, esok adalah misteri, namun hari
                    ini adalah anugerah. Itu sebabnya disebut masa kini. <br><small>#Master Oogway</small></p>
                  <div class="slider__btn" data-animation="fadeInUp" data-delay="1.1s">
                    <a href="/berita/all" class="tp-btn">Lihat Berita</a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="features__icon mr-25">
                <svg width="42" height="44" viewBox="0 0 42 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path
                    ...
                    stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M40.4408 28.3077V15.7054" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </div>
              <div class="features__content">
                <h3 class="features__title">
                  <a href="/ukm/all">Unit Kegiatan Mahasiswa</a>
                </h3>
                <p>Unit Kegiatan Mahasiswa terbaik ada di sini</p>

                <a href="/ukm/all" class="link-btn">Selengkapnya <i class="fa-regular fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
            <div class="features__item features__border-right d-sm-flex align-items-start white-bg mb-30">
              <div class="features__icon mr-25">
                <svg width="44" height="40" viewBox="0 0 44 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.7168 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M14.3835 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M22.0501 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M29.7168 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M37.3835 31.4941V18.0775" stroke="#3D6CE7" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path
                  ...
                  <path
                    ...
                    stroke="#031220" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M0.966797 39.1608H43.1335" stroke="#031220" stroke-width="1.5" stroke-miterlimit="10"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path
              ...
              <div class="features__content">
                <h3 class="features__title">
                  <a href="/berita/all">Berita Terbaru</a>
                </h3>
                <p>Berita terbaru seputar ukm UNIBA Madura.</p>

                <a href="/berita/all" class="link-btn">Selengkapnya <i class="fa-regular fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
              ...
              <div class="features__icon mr-25">
                <svg width="41" height="38" viewBox="0 0 41 38" fill="none"
                  ...
                  <path
                    ...
                    stroke="#031220" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M20.1666 6.41956V35.1696" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M12.0209 12.1696H7.70837" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M13.4584 17.9196H7.70837" stroke="#3D6CE7" stroke-width="1.5" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </div>
              <div class="features__content">
                <h3 class="features__title">
                  <a href="/galeri/all">Galeri UKM</a>
                </h3>
                <p>Prestasi prestasi yang telah diraih ukm UNIBA Madura</p>

                <a href="/galeri/all" class="link-btn">Learn More <i class="fa-regular fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="about__thumb-wrapper d-sm-flex mr-20 p-relative">
            <div class="about__shape">
              <img class="about__shape-1 d-none d-sm-block"
                src="{{ asset('eduker') }}/assets/img/about/about-shape-1.png" alt="">
              <img class="about__shape-2 d-none d-sm-block"
                src="{{ asset('eduker') }}/assets/img/about/about-shape-2.png" alt="">
              <img class="about__shape-3" src="{{ asset('eduker') }}/assets/img/about/about-shape-3.png"
                alt="">
            </div>
            <div class="about__thumb-left mr-10">
              <div class="about__thumb-1 mb-10">
                <img src="{{ asset('eduker') }}/assets/img/about/about-1.jpg" alt="">
              </div>
              <div class="about__thumb-1 mb-10 text-end">
                <img src="{{ asset('eduker') }}/assets/img/about/about-3.jpg" alt="">
              </div>
            </div>
            <div class="about__thumb-2 mb-10">
              <img src="{{ asset('eduker') }}/assets/img/about/about-2.jpg" alt="">
            </div>
          </div>
        </div>
        <div class="col-xxl-5 col-xl-5 col-lg-5">
          <div class="about__content pl-70 pr-25">
            <div class="section__title-wrapper mb-15">
              <span class="section__title-pre">Tentang insider</span>
              <h2 class="section__title">Sistem Informasi Unit Kegiatan Mahasiswa UNIBA MADURA</h2>
            </div>
            <p>Website yang menyajikan informasi penting mengenai ukm di Universitas Bahaudin Mudhary Madura</p>

            <div class="about__list mb-40">
              <ul>
                <li><i class="fa-solid fa-check"></i> Informasi ukm terbaru</li>
                <li><i class="fa-solid fa-check"></i> Berita seputar ukm</li>
                <li><i class="fa-solid fa-check"></i> Informasi Pendaftaran Ukm</li>
              </ul>
            </div>

            <div class="about__btn">
              <a href="/tentang" class="tp-btn tp-btn-2">Selengkapnya</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="counter__item d-flex align-items-start counter__item-border">
              <div class="counter__icon mr-15">
                <svg width="38" height="39" viewBox="0 0 38 39" fill="none"
                  ...
                  <path d="M24.4 2.9668C26.146 8.2228 27.028 13.6948 27.028 19.1668" stroke="#031220" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M2.80005 26.3667V24.5667C8.05605 26.3127 13.528 27.1947 19 27.1947" stroke="#031220"
                    stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                  ...
                  <path class="search" d="M37.0001 37.1667L35.2001 35.3667" stroke="#3D6CE7" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" />
                </svg>
              </div>
              <div class="counter__content">
                <h4><span class="counter">{{ $jumlah_ukm }}</span>+</h4>
                <p>Jumlah UKM Aktif</p>
              </div>
            </div>
          </div>
          <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
            <div class="counter__item d-flex align-items-start counter__item-border">
              <div class="counter__icon mr-15">
                <svg width="50" height="38" viewBox="0 0 50 38" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path d="M14.6984 27.5676V25.3757H16.1609V27.5676H14.6984Z" fill="#031220" stroke="#F5F6F8"
                    stroke-width="0.1" />
                  <path d="M18.9289 27.5676V25.3757H20.3914V27.5676H18.9289Z" fill="#031220" stroke="#F5F6F8"
                    stroke-width="0.1" />
                  <path
              ...
              <div class="counter__content">
                <h4><span class="counter">{{ $jumlah_berita }}</span>+</h4>
                <p>Jumlah Berita ter post</p>
              </div>
            </div>
          </div>
          <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
            <div class="counter__item d-flex align-items-start counter__item-border">
              ...
              <div class="counter__content">
                ...
                <p>Jumlah prestasi-prestasi ukm</p>
              </div>
            </div>
          </div>
          <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-6">
            <div class="counter__item d-flex align-items-start">
              ...
              <div class="counter__content">
                <h4><span class="counter">{{ $visitorCount }}</span>+</h4>
                <p>Pengunjung Insider</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
          ...
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-1.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-1.jpg"
                      alt="">Brian Cumin</a>
                </div>
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-2.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              <div class="course__price">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-2.jpg"
                      alt="">Jack Morkel</a>
                </div>
                <div class="course__lesson">
                  <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-3.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              <div class="course__price">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-3.jpg"
                      alt="">Hilary Ouse</a>
                </div>
                <div class="course__lesson">
                  <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-4.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              <div class="course__price">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-4.jpg"
                      alt="">Phanta Bear</a>
                </div>
                <div class="course__lesson">
                  <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-5.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              <div class="course__price">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-5.jpg"
                      alt="">Hilary Ouse</a>
                </div>
                <div class="course__lesson">
                  <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
        ...
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6">
          <div class="course__item white-bg transition-3 mb-30">
            <div class="course__thumb w-img fix">
              <a href="course-details.html">
                <img src="{{ asset('eduker') }}/assets/img/course/course-6.jpg" alt="">
              </a>
            </div>
            <div class="course__content p-relative">
              <div class="course__price">
              ...
              <div class="course__bottom d-sm-flex align-items-center justify-content-between">
                <div class="course__tutor">
                  <a href="#"><img src="{{ asset('eduker') }}/assets/img/course/tutor/course-tutor-6.jpg"
                      alt="">Oliver Porter</a>
                </div>
                <div class="course__lesson">
                  <a href="#"><svg width="14" height="16" viewBox="0 0 14 16" fill="none"
      ...
      <div class="row grid">
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
          <div class="campus__wrapper">
            <div class="section__title-wrapper mb-25">
              <span class="section__title-pre">Tentang Kampus</span>
              <h2 class="section__title section__title-40">Universitas KH Bahaudin Mudhary</h2>
              <p>Kampus Full Beasiswa yang diperuntukkan masyarakat Madura. Khususnya masyarakat Sumenep</p>
            </div>
            <div class="campus__btn mb-80">
              <a href="https://unibamadura.ac.id/" target="_blank" class="tp-btn tp-btn-border">Selengkapnya</a>
            </div>
          </div>
        </div>
        <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6 grid-item">
          <div class="campus__thumb w-img mb-30">
            <img src="{{ asset('eduker') }}/assets/img/campus/campus-2.jpg" alt="">
            <a href="https://youtu.be/sAaBN0FdGUw?si=WFVawY3FIhS54Odj" class="play-btn popup-video pulse-btn">
        ...
        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
          <div class="campus__thumb w-img mb-25">
            <img src="{{ asset('eduker') }}/assets/img/campus/campus-3.jpg" alt="">
          </div>
        </div>
        <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 grid-item">
          <div class="campus__thumb w-img mb-30">
            <img src="{{ asset('eduker') }}/assets/img/campus/campus-1.jpg" alt="">
          </div>
        </div>
        <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6 grid-item">
          <div class="campus__thumb w-img mb-30">
            <img src="{{ asset('eduker') }}/assets/img/campus/campus-4.jpg" alt="">
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="research__area research__border grey-bg-3 pt-115 pb-90 p-relative z-index-1">
    <div class="research__shape">
      <img class="research__shape-1 d-none d-sm-block"
        src="{{ asset('eduker') }}/assets/img/research/research-shape-1.png" alt="">
      <img class="research__shape-2 d-none d-sm-block"
        src="{{ asset('eduker') }}/assets/img/research/research-shape-2.png" alt="">
      <img class="research__shape-3" src="{{ asset('eduker') }}/assets/img/research/research-shape-3.png"
        alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper mb-50 text-center">
            <span class="section__title-pre">Unit Kegiatan Mahasiswa</span>
            <h2 class="section__title section__title-44">UKM Terbaru</h2>
          </div>
        </div>
      </div>
      <div class="row">

        @foreach ($latestUkm as $item)
          <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
            <div class="research__item research__item-border active text-center mb-30 transition-3">
              <div class="research__thumb mb-35">
                <img src="{{ asset('image/ukm/' . $item->logo_ukm) }}" alt="">
              </div>
              <div class="research__content">
                <h3 class="research__title">{{ $item->nama_ukm }}</h3>
                <p>{!! substr($item->deskripsi_ukm, 0, 50) !!}...</p>
              </div>
            </div>
          </div>
        @endforeach
  ...
  <section class="blog__area pt-120 pb-85 p-relative">
    <div class="blog__shape">
      <img class="blog__shape-1" src="{{ asset('eduker') }}/assets/img/blog/blog-shape-1.png" alt="">
      <img class="blog__shape-2" src="{{ asset('eduker') }}/assets/img/blog/blog-shape-2.png" alt="">
      <img class="blog__shape-3" src="{{ asset('eduker') }}/assets/img/blog/blog-shape-3.png" alt="">
      <img class="blog__shape-4" src="{{ asset('eduker') }}/assets/img/blog/blog-shape-4.png" alt="">
    </div>
    <div class="container">
      <div class="row">
        <div class="col-xxl-12">
          <div class="section__title-wrapper mb-60 text-center">
            <span class="section__title-pre">Berita Terbaru</span>
            <h2 class="section__title section__title-44">Berita Terbaru UKM UNIBA</h2>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-xxl-6 col-xl-6">
          <div
            ...
            <div class="blog__thumb-bg w-img fix"
              data-background="{{ asset('image/berita/' . $latestBerita->gambar_berita) }}">
            </div>
            <div class="blog__content-float">
              <div class="blog__tag-float mb-15">
                <a href="/berita/{{ $latestBerita->token_berita }}/detail">Selengkapnya</a>
              </div>
              <h3 class="blog__title-float">
                <a href="/berita/{{ $latestBerita->token_berita }}/detail">{{ $latestBerita->nama_berita }}</a>
              </h3>
                ...
                <ul>
                  <li>
                    <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                        ...
                        <path d="M11.7822 11.3848L9.45723 9.99732C9.05223 9.75732 8.72223 9.17982 8.72223 8.70732V5.63232"
                          stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                      </svg><a href="#">{{ $latestBerita->created_at->format('d, M Y') }}</a></span>
                  </li>
                  <li>
        ...
        @foreach ($latestBerita_2 as $item)
                    ...
                    <li>
                      <span><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                          ...
                          <path
                            ...
                            stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg><a href="#">{{ $item->created_at->format('d, M Y') }}</a></span>
                    </li>
                    <li>
                      <span><svg width="16" height="14" viewBox="0 0 16 14" fill="none"
                          xmlns="http://www.w3.org/2000/svg">
