...
<head>
  ...
  <link href="{{ asset('favicon-white.png') }}" rel="shortcut icon" type="image/png">
  <link href="{{ asset('kleon') }}/assets/img/apple-touch-icon.html" rel="apple-touch-icon">
  <link href="{{ asset('kleon') }}/assets/img/apple-touch-icon-72x72.html" rel="apple-touch-icon" sizes="72x72">
  <link href="{{ asset('kleon') }}/assets/img/apple-touch-icon-114x114.html" rel="apple-touch-icon" sizes="114x114">
  <link href="{{ asset('kleon') }}/assets/img/apple-touch-icon-144x144.html" rel="apple-touch-icon" sizes="144x144">

  <!-- Page Title -->
  <title>Insider - Admin Pages</title>

  <!-- Styles Include -->
  <link rel="stylesheet" href="{{ asset('kleon') }}/assets/css/main.css" id="stylesheet">
  ...
  <!-- Sweet Alert -->
  <script src="{{ asset('kleon') }}/plugins/sweetalert/sweetalert.js"></script>
  <script src="{{ asset('kleon') }}/plugins/sweetalert/sweetalert2.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/sweetalert/sweetalert2-init.js"></script>
  <script src="{{ asset('kleon') }}/plugins/nicescroll/jquery.nicescroll.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/nicescroll/jquery.nicescroll.min.js"></script>
...
<body class="bg-light">
  ...
  <div id="preloader">
    <div class="preloader-inner">
      ...
      <div class="logo"><img src="{{ asset('favicon-white.png') }}" alt="img"></div>
    </div>
  </div>
        ...
        <div class="header-left-part d-flex align-items-center flex-grow-1 w-100">
          {{-- <div class="header-search w-100">
            <form class="search-form" action="https://wpthemebooster.com/demo/themeforest/html/kleon/search.php">
              ...
              <button type="submit" class="btn"><img src="{{ asset('kleon') }}/assets/img/svg/search.svg"
                  alt=""></button>
            </form>
          </div> --}}
        </div>
        ...
        <div class="header-right-part d-flex align-items-center flex-shrink-0">
          <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
            <li class="nav-item nav-color-switch d-flex align-items-center gap-3">
              <div class="sun"><img src="{{ asset('kleon') }}/assets/img/sun.svg" alt="img"></div>
              <div class="switch">
              ...
              <div class="moon"><img src="{{ asset('kleon') }}/assets/img/moon.svg" alt="img"></div>
            </li>
            ...
            <li class="nav-item nav-notification dropdown">
              <a href="#" class="nav-toggler" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{ asset('kleon') }}/assets/img/svg/bell.svg" alt="bell">
              ...
              <div class="dropdown-widget dropdown-menu p-0">
                <div class="dropdown-wrapper pd-50">
                  <div class="dropdown-wrapper--title">
                    <h4 class="d-flex align-items-center justify-content-between">Notifications <a href="#">View
                        All</a></h4>
                  </div>
                  <ul class="notification-board list-unstyled">
                    <li class="author-online has-new-message d-flex gap-3">
                      ...
                      <div class="user-message">
                        <h6 class="message"><a href="#">Jackie Kun</a> mentioned you at <a href="#">Kleon
                            Projects</a></h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span
                            class="fs-14 text-gray fw-normal">2m ago</span> <span>Mark as read</span></p>
                      </div>
                    </li>
                    <li class="author-online has-new-message d-flex gap-3">
                      ...
                      <div class="user-message">
                        <h6 class="message"><a href="#">Olivia Johanna</a> has created new task at <a
                    ...
                    <li class="author-online has-new-message d-flex gap-3">
                      ...
                      <div class="user-message">
                        <h6 class="message">[REMINDER] Due date of <a href="#">Highspeed Studios Projects</a> te
                          task will be coming</h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span
                            class="fs-14 text-gray fw-normal">2m ago</span> <span>Mark as read</span></p>
                      </div>
                    </li>
                  ...
                  <h6 class="all-notifications"> <a href="#"
                      class="btn bg-muted text-primary w-100 fw-bold mt-3 ff-heading px-0">View All Notifications</a>
                  </h6>
                </div>
              </div>
            </li>
            ...
            <li class="nav-item nav-settings">
              <a href="#" class="nav-toggler">
                <img src="{{ asset('kleon') }}/assets/img/svg/settings.svg" alt="img">
              </a>
            </li>
                  ...
                  <div class="card mb-0">
                    ...
                    <div class="card-body p-3">
                      <ul class="list-unstyled p-0 m-0">
                        <li>
                          <a href="profile.html" class="fs-14 fw-normal text-dark d-block p-1"><i
                              class="bi bi-person me-2"></i> Profile</a>
                        </li>
                        <li>
                          <a href="email.html" class="fs-14 fw-normal text-dark d-block p-1"><i
    ...
    <div class="small-header d-flex align-items-center justify-content-between d-xl-none">
      <div class="logo">
        <a href="index.html" class="d-flex align-items-center gap-3 flex-shrink-0">
          <img src="{{ asset('kleon') }}/assets/img/logo-icon.svg" alt="logo">
          <div class="position-relative flex-shrink-0">
            <img src="{{ asset('kleon') }}/assets/img/logo-text.svg" alt="" class="logo-text">
            <img src="{{ asset('kleon') }}/assets/img/logo-text-white.svg" alt="" class="logo-text-white">
          </div>
        </a>
      </div>
      <div>
        ...
        <button type="button" class="kleon-mobile-menu-opener"><span class="close"><i
              class="bi bi-arrow-left"></i></span> <span class="open"><i class="bi bi-list"></i></span></button>
      </div>
    </div>
    ...
    <div class="d-none d-xl-block">
      <div
        ...
        <div class="d-flex align-items-center gap-7">
          <div class="logo">
            <a href="/dashboard" class="d-flex align-items-center gap-3 flex-shrink-0">
              {{-- <img src="{{ asset('kleon') }}/assets/img/fix/favicon.png" alt="logo"> --}}
              <div class="position-relative flex-shrink-0">
                <img src="{{ asset('kleon') }}/assets/img/fix/logo_2.png" alt="" class="logo-text">
                <img src="{{ asset('kleon') }}/assets/img/fix/logo_2_white.png" alt=""
          ...
          <div class="kleon-navmenu text-center">
            <ul class="main-menu">
              ...
              <li class="menu-item menu-item-has-children"><a href="#"> <span class="nav-icon flex-shrink-0"><i
                      class="bi bi-speedometer fs-16"></i></span> <span class="nav-text">Dashboards</span></a>
                <ul class="sub-menu">
              ...
              <li class="menu-item menu-item-has-children"><a href="#"> <span class="nav-icon flex-shrink-0"><i
                      class="bi bi-speedometer2 fs-16"></i></span> <span class="nav-text">Sass</span></a>
                <ul class="sub-menu">
                  <!-- HR Management -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-people fs-16"></i></span> <span
                        class="nav-text">HR Management</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="employees.html"> Employees <span
                            class="menuIndicator bg-soft-secondary rounded-3 py-0 px-3">New</span></a></li>
                      <li class="menu-item"><a href="recruitment.html"> Recruitment</a></li>
                      <li class="menu-item"><a href="jobs.html"> Jobs <span
                            class="menuIndicator bg-info rounded-circle text-white">17</span></a></li>
                  ...
                  <!-- Job Hiring -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-briefcase fs-16"></i></span> <span
                        class="nav-text">Job Hiring</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="jobs-hiring.html"> Jobs <span
                            class="menuIndicator bg-info rounded-circle text-white">17</span></a></li>
                      <li class="menu-item menu-item-has-children"><a href="#"> Candidates</a>
                        <ul class="sub-menu">
                          ...
                          <li class="menu-item"><a href="candidates-qualified-hiring.html"> Qualified Candidates</a>
                          </li>
                  ...
                  <!-- Project Management -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-kanban fs-16"></i></span> <span
                        class="nav-text">Project Management</span></a>
                    <ul class="sub-menu">
                  ...
                  <!-- General Dashboard -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-speedometer2 fs-16"></i></span> <span
                        class="nav-text">General Dashboard</span></a>
                    <ul class="sub-menu">
              ...
              <!-- Apps -->
              <li class="menu-item menu-item-has-children"><a href="#"> <span class="nav-icon flex-shrink-0"><i
                      class="bi bi-app-indicator fs-16"></i></span> <span class="nav-text">Apps</span></a>
                <ul class="sub-menu">
                  <li class="menu-item"><a href="calendar.html"><span class="nav-icon flex-shrink-0"><i
                          class="bi bi-calendar-day fs-16"></i></span> <span class="nav-text">Calendar</span></a></li>

                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-envelope fs-16"></i></span> <span
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-chat fs-16"></i></span> <span
                        class="nav-text">Chat</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-receipt fs-16"></i></span> <span
              ...
              <!-- UI Components -->
              <li class="menu-item menu-item-has-children"><a href="#"> <span class="nav-icon flex-shrink-0"><i
                      class="bi bi-bricks fs-16"></i></span> <span class="nav-text">Components</span></a>
                <ul class="sub-menu">
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-bricks fs-16"></i></span> <span
                        class="nav-text">UI Elements</span></a>
                    <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-card-image fs-16"></i></span> <span
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-send fs-16"></i></span> <span
                        class="nav-text">Buttons</span></a>
                    <ul class="sub-menu">
                  ...
                  <!-- Forms -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-textarea-resize fs-16"></i></span> <span
                        class="nav-text">Forms</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-textarea-t fs-16"></i></span> <span
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-check-square-fill fs-16"></i></span> <span
                  ...
                  <!-- Content -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-fonts fs-16"></i></span> <span
                        class="nav-text">Content</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="typography.html"><span class="nav-icon flex-shrink-0"><i
                              class="bi bi-fonts fs-16"></i></span> <span class="nav-text">Typography</span></a></li>
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-table fs-16"></i></span> <span
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"><span
                        class="nav-icon flex-shrink-0"><i class="bi bi-plugin fs-16"></i></span> <span
              ...
              <!-- Pages -->
              <li class="menu-item menu-item-has-children"><a href="#"> <span class="nav-icon flex-shrink-0"><i
                      class="bi bi-briefcase fs-16"></i></span> <span class="nav-text">Pages</span></a>
                <ul class="sub-menu">
                  <!-- Authentication -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-person-bounding-box fs-16"></i></span> <span
                        class="nav-text">Authentication</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-info-circle fs-16"></i></span> <span
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-box-arrow-in-right fs-16"></i></span> <span
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-person-plus fs-16"></i></span> <span
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-key fs-16"></i></span> <span
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-qr-code-scan fs-16"></i></span> <span
                  ...
                  <!-- Charts -->
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                        class="nav-icon flex-shrink-0"><i class="bi bi-graph-up-arrow fs-16"></i></span> <span
                        class="nav-text">Charts</span></a>
                    <ul class="sub-menu">
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-pie-chart-fill fs-16"></i></span> <span
        ...
        <div class="d-flex align-items-center flex-shrink-0">
          <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
            <li class="nav-item nav-search">
              <button type="button" class="btn p-0 m-0 border-0" data-bs-toggle="modal"
                data-bs-target="#searchModal">
                <img src="{{ asset('kleon') }}/assets/img/svg/search.svg" alt="">
              </button>
            </li>
            <li class="nav-item nav-color-switch d-flex align-items-center gap-3">
              <div class="sun"><img src="{{ asset('kleon') }}/assets/img/sun.svg" alt="img"></div>
    ...
    <div class="small-header d-flex align-items-center justify-content-between d-xl-none">
      <div class="logo">
        <a href="index.html" class="d-flex align-items-center gap-3 flex-shrink-0">
          ...
          <div class="position-relative flex-shrink-0">
            <img src="{{ asset('kleon') }}/assets/img/fix/logo_2.png" alt="" class="logo-text">
            <img src="{{ asset('kleon') }}/assets/img/fix/logo_2_white.png" alt="" class="logo-text-white">
          </div>
        </a>
      </div>
      <div>
        ...
        <div class="d-flex align-items-center flex-shrink-0">
          <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
                ...
                <div class="dropdown-wrapper pd-50">
                  ...
                  <ul class="notification-board list-unstyled">
                    ...
                    <li class="author-online has-new-message d-flex gap-3">
                      ...
                      <div class="user-message">
                        <h6 class="message">[REMINDER] Due date of <a href="#">Highspeed Studios Projects</a>
                          te task will be coming</h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span
                            class="fs-14 text-gray fw-normal">2m ago</span> <span>Mark as read</span></p>
                      </div>
                    </li>
            ...
            <li class="nav-item nav-giftbox">
              <a href="#" class="nav-toggler" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{ asset('kleon') }}/assets/img/svg/gift.svg" alt="img">
                <div class="badge rounded-circle">5</div>
              </a>
              <div class="dropdown-widget dropdown-menu p-0">
                <div class="dropdown-wrapper pd-50">
                  <div class="dropdown-wrapper--title">
                    <h4 class="d-flex align-items-center justify-content-between">Notifications <a href="#"><i
                          class="bi bi-three-dots-vertical"></i></a></h4>
                  </div>
                  <ul class="notification-board list-unstyled">
                    <li class="author-online has-new-message d-flex gap-3">
                    ...
                    <li class="author-online has-new-message d-flex gap-3">
                      ...
                      <div class="user-message d-flex align-items-center justify-content-between gap-5">
                        <h6 class="message mb-0">Your Premium service end soon. <a href="#">Renew your
                            service</a></h6>
                        <p class="message-footer flex-shrink-0 mb-0"> <span class="time">08:00 AM</span></p>
                      </div>
                    </li>
            ...
            <li class="nav-item nav-folder">
              <a href="#" class="nav-toggler">
                <img src="{{ asset('kleon') }}/assets/img/svg/folder.svg" alt="img">
                <div class="badge rounded-circle">!</div>
              </a>
              <div class="dropdown-widget dropdown-menu dropdown-schedule p-0">
                <div class="dropdown-wrapper pd-50">
                  <div class="dropdown-wrapper--title">
                    <h4 class="d-flex align-items-center justify-content-between">Schedule <a href="#"><i
                          class="bi bi-three-dots-vertical"></i></a></h4>
                  ...
                  <ul class="notification-board list-unstyled">
                    <li class="author-online has-new-message d-flex gap-3">
                      <div class="media">
                        <img src="{{ asset('kleon') }}/assets/img/2.jpg" alt="img" width="60"
                          class="rounded-2">
                      </div>
                      <div class="user-message">
                        <h6 class="message mb-1"><a href="#" class="text-dark">Meeting with Candidate #1</a>
                        </h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span><i
                              class="bi bi-calendar-fill"></i> January 17, 2023</span> <span><i
                              class="bi bi-clock-fill"></i> 10.00 - 11.00</span></p>
                      </div>
                    </li>
                    <li class="author-online has-new-message d-flex gap-3">
                      <div class="media">
                        <img src="{{ asset('kleon') }}/assets/img/4.jpg" alt="img" width="60"
                          class="rounded-2">
                      </div>
                      <div class="user-message">
                        <h6 class="message mb-1"><a href="#" class="text-dark">Meeting with Candidate #2</a>
                        </h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span><i
                              class="bi bi-calendar-fill"></i> January 17, 2023</span> <span><i
                              class="bi bi-clock-fill"></i> 10.00 - 11.00</span></p>
                    ...
                    <li class="author-online has-new-message d-flex gap-3">
                      <div class="media">
                        <img src="{{ asset('kleon') }}/assets/img/6.jpg" alt="img" width="60"
                          class="rounded-2">
                      </div>
                      <div class="user-message">
                        <h6 class="message mb-1"><a href="#" class="text-dark">Meeting with Candidate #3</a>
                        </h6>
                        <p class="message-footer d-flex align-items-center justify-content-between"> <span><i
                              class="bi bi-calendar-fill"></i> January 17, 2023</span> <span><i
                              class="bi bi-clock-fill"></i> 10.00 - 11.00</span></p>
                  ...
                  <h6 class="all-notifications"> <a href="#"
                      class="btn bg-muted text-primary w-100 fw-bold mt-3 ff-heading px-0">View All</a> </h6>
                </div>
              </div>
            </li>
        ...
        <div class="d-flex align-items-center gap-7 order-1 order-xl-0">
          <div class="kleon-navmenu text-center">
            <ul class="main-menu">
              ...
              <!-- Apps -->
              <li class="menu-item menu-item-has-children"><a href="#"> <span
                    class="nav-icon flex-shrink-0"><i class="bi bi-app-indicator fs-16"></i></span> <span
                    class="nav-text">Apps</span></a>
                <ul class="sub-menu">
                  <li class="menu-item"><a href="calendar.html"><span class="nav-icon flex-shrink-0"><i
                          class="bi bi-calendar-day fs-16"></i></span> <span class="nav-text">Calendar</span></a>
                  </li>
                ...
                <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-check-square-fill fs-16"></i></span>
                          <span class="nav-text">Form Validation</span></a>
                        <ul class="sub-menu">
                          <li class="menu-item"><a href="form-validation-bootstrap.html">Bootstrap Validation</a>
                          </li>
                          <li class="menu-item"><a href="form-validation-custom.html">Custom Validation</a></li>
                        </ul>
                        <span class='submenu-opener'><i class='bi bi-chevron-right'></i></span>
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                    ...
                    <ul class="sub-menu">
                      <li class="menu-item"><a href="typography.html"><span class="nav-icon flex-shrink-0"><i
                              class="bi bi-fonts fs-16"></i></span> <span class="nav-text">Typography</span></a>
                      </li>
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-table fs-16"></i></span> <span
                            class="nav-text">Tables</span></a>
                ...
                <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-has-children"><a href="#"> <span
                    ...
                    <ul class="sub-menu">
                      ...
                      <li class="menu-item menu-item-has-children"><a href="#"><span
                            class="nav-icon flex-shrink-0"><i class="bi bi-box-arrow-in-right fs-16"></i></span>
    ...
    <div class="small-header d-flex align-items-center justify-content-between d-xl-none">
      <div class="logo">
        <a href="index.html" class="d-flex align-items-center gap-3 flex-shrink-0">
          ...
          <div class="position-relative flex-shrink-0">
            <img src="{{ asset('kleon') }}/assets/img/logo-text.svg" alt="" class="logo-text">
            <img src="{{ asset('kleon') }}/assets/img/logo-text-white.svg" alt=""
              class="logo-text-white">
          </div>
        </a>
      </div>
  ...
  <div class="kleon-vertical-nav">
    ...
    <div class="logo d-flex align-items-center justify-content-between">
      <a href="/dashboard" class="d-flex align-items-center gap-3 flex-shrink-0">
        {{-- <img src="{{ asset('kleon') }}/assets/img/fix/favicon.png" alt="logo" height="50px"> --}}
        <div class="position-relative flex-shrink-0">
          <img src="{{ asset('kleon') }}/assets/img/fix/logo_2.png" alt="" class="logo-text" height="80px">
          <img src="{{ asset('kleon') }}/assets/img/fix/logo_2_white.png" alt="" class="logo-text-white">
        </div>
      </a>
    ...
    <div class="kleon-navmenu">
      ...
      <ul class="main-menu">
        ...
        <li class="menu-item"><a href=""> <span class="nav-icon flex-shrink-0">
              <i class="bi bi-speedometer fs-18"></i></span> <span class="nav-text">Dashboards</span></a>
        </li>
        ...
        <!-- UKM -->
        <li class="menu-item"><a href="/kategori/ukm"> <span class="nav-icon flex-shrink-0"><i
                class="bi bi-view-list fs-18"></i></span> <span class="nav-text">Kategori UKM</span></a>
        </li>
        <!-- BERITA -->
        <li class="menu-item"><a href="/kategori/berita"> <span class="nav-icon flex-shrink-0"><i
                class="bi bi-journal-text fs-18"></i></span> <span class="nav-text">Kategori Berita</span></a>
        </li>
        ...
        <li class="menu-item"><a href="/ukm"><span class="nav-icon flex-shrink-0"><i
                class="bi bi-collection fs-18"></i></span> <span class="nav-text">UKM</span></a></li>

        <li class="menu-item"><a href="/berita"><span class="nav-icon flex-shrink-0"><i
                class="bi bi-newspaper fs-18"></i></span> <span class="nav-text">Berita</span></a></li>

        <!-- Charts -->
        <li class="menu-section-title text-gray ff-heading fs-16 fw-bold text-uppercase mt-4 mb-2"><span>Others</span>
        </li>
        <li class="menu-item"><a href="/admin/galeri"><span class="nav-icon flex-shrink-0"><i
                class="bi bi-pie-chart fs-18"></i></span> <span class="nav-text">Galeri</span></a>
        </li>
              ...
              <label class="form-label mb-0" for="verticalNav">
                <span class="d-inline-block mb-2">
                  <img class="light-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/vertical-light.png" alt="img">
                  <img class="dark-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/vertical-dark.png" alt="img">
                </span>
          ...
          <div class="col-4">
            <div class="form-check form-check-inline with-layout-image m-0">
              ...
              <label class="form-label mb-0" for="horizontalNav">
                <span class="d-inline-block mb-2">
                  <img class="light-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/horizontal-light.png" alt="img">
                  <img class="dark-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/horizontal-dark.png" alt="img">
                </span>
          ...
          <div class="col-4">
            <div class="form-check form-check-inline with-layout-image m-0">
              ...
              <label class="form-label mb-0" for="comboNav">
                <span class="d-inline-block mb-2">
                  <img class="light-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/combo-light.png" alt="img">
                  <img class="dark-version img-fluid rounded-1"
                    src="{{ asset('kleon') }}/assets/img/customizer/combo-dark.png" alt="img">
                </span>
  ...
  <!-- Core JS -->
  <script src="{{ asset('kleon') }}/assets/js/jquery-3.6.0.min.js"></script>
  <script src="{{ asset('kleon') }}/assets/js/bootstrap.bundle.min.js"></script>

  <!-- jQuery UI Kit -->
  <script src="{{ asset('kleon') }}/plugins/jquery_ui/jquery-ui.1.12.1.min.js"></script>

  <!-- ApexChart -->
  <script src="{{ asset('kleon') }}/plugins/apexchart/apexcharts.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/apexchart/apexchart-inits/apexcharts-analytics-2.js"></script>

  <!-- Peity  -->
  <script src="{{ asset('kleon') }}/plugins/peity/jquery.peity.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/peity/piety-init.js"></script>

  <!-- Select 2 -->
  <script src="{{ asset('kleon') }}/plugins/select2/js/select2.min.js"></script>

  <!-- Datatables -->
  <script src="{{ asset('kleon') }}/plugins/datatables/js/jquery.dataTables.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/datatables/js/datatables.init.js"></script>



  <!-- Date Picker -->
  <script src="{{ asset('kleon') }}/plugins/flatpickr/flatpickr.min.js"></script>

  <!-- Dropzone -->
  <script src="{{ asset('kleon') }}/plugins/dropzone/dropzone.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/dropzone/dropzone_custom.js"></script>

  <!-- TinyMCE -->
  <script src="{{ asset('kleon') }}/plugins/tinymce/tinymce.min.js"></script>
  <script src="{{ asset('kleon') }}/plugins/prism/prism.js"></script>
  <script src="{{ asset('kleon') }}/plugins/jquery-repeater/jquery.repeater.js"></script>
  ...
  <!-- Snippets JS -->
  <script src="{{ asset('kleon') }}/assets/js/snippets.js"></script>

  <!-- Theme Custom JS -->
  <script src="{{ asset('kleon') }}/assets/js/theme.js"></script>
...
<!-- Mirrored from wpthemebooster.com/demo/themeforest/html/kleon/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 29 May 2024 18:43:45 GMT -->
