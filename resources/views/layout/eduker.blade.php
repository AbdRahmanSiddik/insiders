...
<!-- Mirrored from wphix.com/html/eduker-html/eduker/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jun 2024 06:27:52 GMT -->

<head>
  <meta charset="utf-8">
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title>Insider – Informasi UKM UNIBA MADURA</title>
                    ...
                    <a href="/">
                      <svg viewBox="0 0 15 13">
                        ...
                        <path
                          ...
                          fill="#4B535A" />
                      </svg> <span class="__cf_email__">insiders@gmail.com</span></a>
                  </li>
                  <li>
                    <a href="/" target="_blank">
                      ...
                      Sumenep, Jawa Timur, 2024 Indonesia</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
              <div class="header__top-right d-flex justify-content-end align-items-center">
                ...
                <div class="header__btn ml-20">
                  <a href="/kontak" class="header-btn">contact us</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 col-6">
              <div class="logo">
                <a href="/">
                  <img src="{{ asset('eduker') }}/assets/img/logo/logo-2.png" alt="logo">
                </a>
              </div>
            </div>
                ...
                <nav id="mobile-menu">
                  <ul>
                    ...
                    <li class="has-dropdown">
                      <a href="/berita/all">Berita</a>
                      <ul class="submenu">
                        @foreach (kategori_berita() as $item)
                          <li><a href="/berita/{{ $item['kategori_id'] }}/all">{{ $item['nama_kategori'] }}</a></li>
                        @endforeach
                      </ul>
                    </li>
                    <li class="has-dropdown">
                      <a href="/ukm/all">UKM</a>
                      <ul class="submenu">
                        @foreach (kategori_ukm() as $item)
                          <li><a href="/ukm/{{ $item['kategori_id'] }}/all">{{ $item['nama_kategori'] }}</a></li>
                        @endforeach
                      </ul>
                    </li>
                    <li>
                    ...
                    <li class="has-dropdown">
                        <a href="/hitung">UKM Terbaik</a>
                        <ul class="submenu">
                            <li><a href="/hitung">UKM Terbaik</a></li>
                            <li><a href="/student/preferences">See UKM for me</a></li>
                        </ul>
                    </li>
                  </ul>
                </nav>
                ...
                <div class="header__search w-100 d-none d-xl-block">
                  {{-- <form action="#">
                    <div class="header__search-input">
                      ...
                      <button class="header__search-btn"><svg width="18" height="18" viewBox="0 0 18 18"
                          ...
                          <path
                            ...
                            stroke="#031220" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                          <path d="M17 17L13.1334 13.1333" stroke="#031220" stroke-width="2" stroke-linecap="round"
                  ...
                  <div class="header__search-input">
                    <a href="https://unibamadura.ac.id/" target="_blank"><img src="{{ asset('uniba.jpg') }}"
                        alt="UNIBA MADURA" width="50px" class="ms-2"></a>
                    <a href="https://turbo-main.my.id/" target="_blank"><img src="{{ asset('turbo.png') }}"
                        alt="TURBO-MAIN" width="50px" class="ms-2"></a>
                  </div>
                </div>
                ...
                <ul>
                  <li class="d-flex align-items-center">
                    ...
                    <div class="offcanvas__contact-text">
                      <a target="_blank" href="#">Sumenep, Jawa Timur</a>
                    </div>
                  </li>
                  <li class="d-flex align-items-center">
                    <div class="offcanvas__contact-icon mr-15">
                  ...
                  <li class="d-flex align-items-center">
                    ...
                    <div class="offcanvas__contact-text">
                      <a href="tel:+012-345-6789"><span class="__cf_email__">insiders@gmail.com</span></a>
                    </div>
                  </li>
                </ul>
              </div>
              <div class="offcanvas__social mb-2">
                <ul>
                  <li>
                    <a href="https://unibamadura.ac.id/" target="_blank" class="p-0 m-0 text-center">
                      <img src="{{ asset('uniba.jpg') }}" alt="UNIBA MADURA" width="100%" class="ms-2">
                    </a>
                  </li>
                  <li>
                    <a href="https://turbo-main.my.id/" target="_blank" class="p-0 m-0 text-center">
                      <img src="{{ asset('turbo.png') }}" alt="TURBO-MAIN" width="100%" class="ms-2">
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <div class="row">
              ...
              <div class="footer__widget footer-col-1 mb-50">
                ...
                <div class="footer__widget-content">
                  <div class="footer__widget-info">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisc ing elit. Nunc maximus, nulla utlaoki comm odo
                      sagittis.</p>
            ...
            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-5">
              <div class="footer__widget mb-50">
                <h3 class="footer__widget-title">UKM</h3>
                <div class="footer__widget-content">
                  <ul>
                    @foreach (kategori_ukm() as $item)
                      <li>
                        <a href="/ukm/{{ $item['kategori_id'] }}/all">{{ $item['nama_kategori'] }}</a>
                      </li>
                    @endforeach
                  </ul>
                </div>
            ...
            <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-5">
              <div class="footer__widget mb-50">
                <h3 class="footer__widget-title">Berita</h3>
                <div class="footer__widget-content">
                  <ul>
                    @foreach (kategori_berita() as $item)
                      <li>
                        <a href="/berita/{{ $item['kategori_id'] }}/all">{{ $item['nama_kategori'] }}</a>
                      </li>
                    @endforeach
                  </ul>
                </div>
            ...
            <div class="row">
              <div class="col-xxl-12">
                <div class="footer__copyright text-center">
                  <p>© 2024 Abd. Rahman Siddik .All Rights Reserved</p>
                </div>
              </div>
            </div>
          </div>
...
<!-- Mirrored from wphix.com/html/eduker-html/eduker/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jun 2024 06:28:16 GMT -->
