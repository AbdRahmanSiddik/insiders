...
@section('content')
  <form action="/berita/tambah" method="POST" enctype="multipart/form-data" novalidate class="card">
    @csrf
    ...
    <div class="card-body row">
      <div class="row col-lg-6 g-3 m-0">
        <div class="col-lg-12 mt-0">
          ...
          <input type="text" name="nama_berita" id="nama_berita" class="form-control">
        </div>
      ...
      <div class="col-lg-12 mt-3">
        ...
        <textarea name="deskripsi_berita" id="editor" required></textarea>
      </div>
    </div>
