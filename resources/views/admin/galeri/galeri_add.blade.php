...
@section('content')
  <form action="/galeri/tambah" method="POST" enctype="multipart/form-data" novalidate class="card">
    @csrf
    ...
    <div class="card-body row bg-light-200">
        ...
        <div class="col-lg-12 mt-0">
          ...
          <select name="id_ukm" id="id_ukm" class="form-control">
            ...
            @foreach ($ukms as $item)
                <option value="{{ $item->id }}">{{ $item->nama_ukm }}</option>
            @endforeach
          </select>
        </div>
        <div class="col-lg-12 mt-0">
      ...
      <div class="col-lg-12 mt-3">
        ...
        <textarea name="deskripsi_galeri" id="editor" required></textarea>
      </div>
    </div>
