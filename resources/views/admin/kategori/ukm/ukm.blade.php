...
@section('content')
    <div class="card border-0 p-5">
        <div class="card-header pb-5 bg-transparent border-0 d-flex align-items-center justify-content-between gap-3">
            <h4 class="mb-0">List Kategori UKM</h4>
            <div class="ms-auto d-flex align-items-center gap-3">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                    aria-controls="offcanvasRight">+ Tambah Kategori UKM</button>

                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight"
                    aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header bg-light-500">
                        <h5 class="offcanvas-title" id="offcanvasRightLabel">Tambah Kategori UKM</h5>
                        <button type="button"
                    ...
                    <div class="offcanvas-body bg-white p-0">
                        <form method="POST" action="/kategori/ukm" class="bg-light-200 p-4">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="table-responsive">
                <table id="table-2" class="display text-center">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th class="text-center">Jumlah UKM</th>
                    ...
                    <tbody>
                        @foreach ($kategoriUkms as $item)
                            <tr>
                                ...
                                <td class="text-center">{{ $item->ukm_count }}</td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/kategori/{{ $item->id }}/ukm_remove" class="btn btn-primary">Save
                                                changes</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasExample{{ $item->id }}" aria-labelledby="offcanvasRightLabel">
                                <div class="offcanvas-header bg-light-500">
                                    <h5 class="offcanvas-title" id="offcanvasRightLabel">Edit Kategori UKM {{ $item->nama_kategori }}</h5>
                                    <button type="button"
                                        class="aside_close btn btn-danger z-index-9 rounded-circle p-0 m-0 d-flex align-items-center justify-content-center"
                                        data-bs-dismiss="offcanvas" aria-label="Close"><i class="bi bi-x-lg"></i></button>
                                </div>
                                <div class="offcanvas-body bg-white">
                                    <form method="POST" action="/kategori/{{ $item->id }}/ukm_edit" class="bg-light-200">
                                        @csrf
                                        <div class="mb-3">
